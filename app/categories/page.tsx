...
export default function CreateCategoryPage() {
    ...
    } = useCreateCategory(reloadCategories, showToast, () => setShowCategoryModal(false));

    const {
        deleteCategory,
        loading: deleteLoading,
    } = useDeleteCategory(reloadCategories, showToast);
    ...
    return (
        <div>
            ...
            loading: deleteLoading,
            {merchantLoading || deleteMerchantLoading || categoryLoading || deleteLoading && <Preloader />}
